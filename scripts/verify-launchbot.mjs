...
for (const requiredText of [
  ...
  "Next Skill: customer-support-release-notes-generator",
...
for (const requiredText of [
  "Generate short release notes for the Customer Support team",
...
for (const requiredText of [
  "Validate StaffAny Customer Support release notes",
  "Evidence-Based Reasoning",
...
for (const requiredText of [
  "Update StaffAny Customer Support release notes",
  "Apply validator `Required Changes` in priority order",
...
for (const requiredText of [
  ...
  "what can u do",
  "code-grounded English and Indonesian help article drafts",
  ...
  "PMM workflow launch derivatives are scoped to help article work items and Customer Support release notes with validator checkpoints only",
  "Pantheon checkout",
  "apps/kraken",
  "apps/gryphon",
  "apps/pixie",
