...
4. Decide material route:
   - `P1`: help article, release notes, changelog/What's New, WhatsApp Community.
   - `P2`: help article and release notes; changelog/WhatsApp only when customer-visible reach is clear.
...
5. For release notes, immediately route to `customer-support-release-notes-generator`.
...
- Changelog: <needed | not_needed | needs-check>
- WhatsApp: <needed | not_needed | needs-check>
Next Skill: customer-support-release-notes-generator when release notes is needed.
```
